class Header:
    ...
    offset : Offset
        Object to define an offset of the whole dataset that may be applied to
        avoid large coordinates and enable inertial relocation and
        re-orientation of datasets.
    """
