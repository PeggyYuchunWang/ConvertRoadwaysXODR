class Object_Marking:
    ...
    start_offset : float
        Lateral offset in u-direction from start of bounding box side where the
        first marking starts.
    stop_offset : float
    ...
    corner_references : list
        List of maximum two IDs that define the marking as a straight line from
        one outline point to another.
