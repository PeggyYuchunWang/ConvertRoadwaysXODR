class Lane_Access:
    """
    Defines access restrictions for certain types of road users for 
    a lane.
    ...
    rule : str
        Specifies whether the participant given in the attribute restriction
        is allowed or denied access to the given lane.
    restriction : str
