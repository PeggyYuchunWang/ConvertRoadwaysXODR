class Signal_Repeat:
    """
    Offers the ability to copy signal information between 
    signals by referencing the content. Represented in
    OpenDRIVE by a <signalReference> element. However,
    it was chosen to change the name to Signal_Repeat
    to reduce confusion between this data type and
    a Signal_Reference element, which is also found
    in a Signal element.
