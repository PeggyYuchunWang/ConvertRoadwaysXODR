class Road_Mark:
    ...
    The style of the center lane that separates left and right lanes 
    is determined by the Road_Mark element for the center lane. 
    ...
    attrib : dict
        ...
        following:
            ...
            lane_change : str
                Allows a lane change in the indicated direction, taking 
                into account that lanes are numbered in ascending order 
                from right to left. If the attribute is missing, “both” 
                is used as default.
    sway : Road_Mark_Sway
    ...
    explicit : Road_Mark_Explicit
        Object to provide detailed information about irregular road 
        markings that cannot be described by repetitive line patterns.      
    """
